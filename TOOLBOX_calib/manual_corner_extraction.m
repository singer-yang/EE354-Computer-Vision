...
fprintf('Do you want to try to automatically find the closest corner? - only works with ckecker board corners  ([]=yes, other = no) ')
...
fprintf('Number(s) of image(s) to process ([] = all images) = ')
