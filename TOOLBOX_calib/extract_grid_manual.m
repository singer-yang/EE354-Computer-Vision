...
if nargin < 2,
    ...
    disp('Window size for corner finder (wintx and winty): enter twice.');
    wintx = input('wintx ([] = 5) = ');
...
while need_to_click,
    ...
    if (n_sq_x1~=n_sq_x2)|(n_sq_y1~=n_sq_y2),
        ...
        if ~click_mode,
            ...
            disp('Could not count the number of squares in the grid. Enter manually. X and Y. enter twice');
...
if ~exist('dX')|~exist('dY'),
    ...
    disp('Size dX, dY of each square. enter twice')
